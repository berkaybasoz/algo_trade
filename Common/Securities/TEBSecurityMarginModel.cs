...
namespace QuantConnect.Securities
{
    ...
    /// </summary>
    public class TEBSecurityMarginModel : ISecurityMarginModel
    {
        ...
        public TEBSecurityMarginModel(decimal initialMarginRequirement, decimal maintenanceMarginRequirement)
        {
        ...
        public TEBSecurityMarginModel(decimal leverage)
        {
            if (leverage < 1)
            {
