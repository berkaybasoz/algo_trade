...
using QuantConnect.Brokerages.TEB;
...
namespace QuantConnect.Lean.Engine.Setup
{
    ...
    /// </summary>
    public class TEBSetupHandler : ISetupHandler
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new <see cref="TEBBrokerage"/> instance
        /// </summary>
        ...
        {
            return new TEBBrokerageFactory().CreateBrokerage(null,uninitializedAlgorithm);
        }
        ...
        public bool Setup(IAlgorithm algorithm, IBrokerage brokerage, AlgorithmNodePacket baseJob, IResultHandler resultHandler, ITransactionHandler transactionHandler, IRealTimeHandler realTimeHandler)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("The TEBBrokerage is for backtests only. Use the BrokerageSetupHandler.");
                }
            }
            catch (Exception err)
            {
